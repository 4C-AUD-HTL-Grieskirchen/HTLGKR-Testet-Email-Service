...
public class EmailHandler {
    ...
    private final String resultText = "<h1>Ihr Testergebnis</h1><p>Ihr Testergbnis lautet:</p><h2>{result}</h2><h2>Download PDF:</h2><a href=\"{URL}\" target=\"_blank\" style=\"padding: 0.6rem 1rem; color: ffffff\">PDF herunterladen</a><p>-------------------------------------</p><p>Bundesministerium</p></p><p>Soziales, Gesundheit, Pflege</p><p>und Konsumentenschutz</p>";
